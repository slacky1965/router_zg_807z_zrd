# Set Project Name
PROJECT_NAME := router_zg_807z_zrd
...
flash-orig-write:
	@python3 $(TOOLS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -z11 -a 100 -s -m we 0 $(BIN_PATH)/origin_flash_dump/router_zg_807z_orig.bin
	
flash-orig-read:
	@python3 $(TOOLS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -z11 -a 100 -s -m rf 0 0x100000 router_zg_807z_orig.bin
...
$(BIN_FILE): $(ELF_FILE)
	...
	@python3 $(MAKE_OTA) -t $(PROJECT_NAME) -m 4098 -i 5634 -v0x1111114b -s "Slacky-DIY OTA" $(BIN_PATH)/$(PROJECT_NAME)_$(VERSION_RELEASE).$(VERSION_BUILD).bin   
	@echo ' '
	@echo 'Finished building: $@'
	@echo ' '
