...
//    printf("zcl_onOffCfgAttr_save()\r\n");
    ...
    st = nv_flashReadNew(1, NV_MODULE_ZCL,  NV_ITEM_ZCL_ON_OFF_CFG, sizeof(zcl_onOffSwitchCfgAttr_t), (u8*)&zcl_nv_onOffCfg);
    ...
    if(st == NV_SUCC) {
        if(zcl_nv_onOffCfg.switchActions != g_zcl_onOffSwitchCfgAttrs.switchActions) {
            ...
            st = nv_flashWriteNew(1, NV_MODULE_ZCL, NV_ITEM_ZCL_ON_OFF_CFG, sizeof(zcl_onOffSwitchCfgAttr_t), (u8*)&zcl_nv_onOffCfg);
        }
